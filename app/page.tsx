...
const Page = () => {
  ...
  return (
    <div className="w-screen h-full bg-[url('/assets/bg-culinaria-1.jpg')] bg-cover bg-center flex flex-col justify-between items-center overflow-x-hidden">
      <Header />
      <div className="w-full h-full flex flex-col justify-around p-2 gap-8 max-w-[1400px] py-8 bg-white/40 md:px-6 lg:flex-row">
        <section className="bg-white/40 flex flex-col gap-4 justify-center items-center lg:w-[500px]">
